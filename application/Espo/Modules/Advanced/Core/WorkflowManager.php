...
class WorkflowManager
{
     ...
     * @return void
     */
    public function process(\Espo\Orm\Entity $entity, $workflowType, $options = [])
    {
    ...
    protected function getWorkflowData()
    {
        ...
        $fieldDefs = $this->getContainer()->get('metadata')->get('entityDefs.Workflow.fields');
        ...
        foreach ($records as $row) {
            ...
            foreach ($this->cacheFields as $fieldName) {
                ...
                if (isset($row[$columnName])) {
                    ...
                    if (in_array($fieldDefs[$fieldName]['type'], array('jsonArray', 'jsonObject'))) {
