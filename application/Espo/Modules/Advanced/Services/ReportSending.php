...
class ReportSending extends \Espo\Core\Services\Base
{
    ...
    {
        $reportSerice = $this->getServiceFactory()->create('Report');

        return new EmailBuilder($this->getMetadata(), $this->getEntityManager(), null, $this->getMailSender(),$this->getConfig(), $this->getLanguage(), $this->getHtmlizer(), $this->getTemplateFileManager(), $reportSerice);
    }
