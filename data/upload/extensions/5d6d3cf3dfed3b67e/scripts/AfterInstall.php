...
class AfterInstall
{
    ...
    protected function getIframeUrl($name)
    {
        ...
        if (method_exists('\\Espo\\Core\Utils\\Util', 'urlAddParam')) {
            return \Espo\Core\Utils\Util::urlAddParam($iframeUrl, $name, 'b05a39a2254aff91765cddbd4982f2af');
        }

        return $this->urlAddParam($iframeUrl, $name, 'b05a39a2254aff91765cddbd4982f2af');
    }
