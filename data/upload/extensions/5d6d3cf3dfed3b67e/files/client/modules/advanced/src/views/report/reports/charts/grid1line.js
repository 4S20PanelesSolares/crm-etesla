...
Espo.define('advanced:views/report/reports/charts/grid1line', 'advanced:views/report/reports/charts/grid1bar-vertical', function (Dep) {
    ...
    return Dep.extend({
        ...
        draw: function () {
            ...
            if (this.chartData.length) {
                this.chartData[0].data.forEach(function (item) {
                    if (item.length == 2 && item[1] && item[1] > max) {
                        max = item[1];
                    }
                }, this);
            }
            ...
            this.$graph = this.flotr.draw(this.$container.get(0), this.chartData, {
                ...
                y2axis: {
                    ...
                    tickFormatter: function (value) {
                        if (value == 0) return '';
                        if (value > this.max2 + 0.07 * this.max2) return '';
                        if (value % 1 == 0) {
