    ...
    return Dep.extend({
        ...
        additionalSetup: function() {
            ...
            if (this.actionData.target) {
                ...
                if (this.options.flowchartCreatedEntitiesData[this.actionData.target]) {
                    this.linkedEntityName = this.options.flowchartCreatedEntitiesData[this.actionData.target].entityType;
                }
            }
        }
