...
Espo.define('advanced:views/workflow/condition-fields/subjects/link-parent', ['view', 'advanced:workflow-helper'], function (Dep, Helper) {
    ...
    return Dep.extend({
        ...
        setup: function () {
            ...
            this.getModelFactory().create(entityType, function (model) {
                ...
                var foreignScopeList = null;
                var entityTypeList = this.getMetadata().get(['entityDefs', entityType, 'fields', field, 'entityList']) || [];
