...
Espo.define('advanced:views/report/detail', 'views/detail', function (Dep) {
        ...
        setup: function () {
            ...
            if (version === 'dev' || arr.length > 2 && parseInt(arr[0]) * 100 + parseInt(arr[1]) >= 506) {
                ...
                if (~['Grid', 'JointGrid'].indexOf(this.model.get('type'))) {
                    iconHtml = '<span class="fas fa-chart-pie"></span> ';
                } else {
                    iconHtml = '';
                }
                ...
                this.addMenuItem('buttons', {
                    ...
                    html: iconHtml + this.translate('Show', 'labels', 'Report'),
                });
            }
        },
