...
Espo.define('advanced:views/report/reports/charts/grid2line', 'advanced:views/report/reports/charts/grid2bar-vertical', function (Dep) {
            ...
            this.$graph = this.flotr.draw(this.$container.get(0), this.chartData, {
                ...
                yaxis: {
                    ...
                    tickFormatter: function (value) {
                        if (value > this.max + 0.09 * this.max) return '';
