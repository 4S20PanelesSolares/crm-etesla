...
Espo.define('advanced:views/report/reports/charts/grid1bar-horizontal', 'advanced:views/report/reports/charts/grid1bar-vertical', function (Dep) {
    ...
    return Dep.extend({
        ...
        draw: function () {
            ...
            if (this.$container.height() === 0) return;
