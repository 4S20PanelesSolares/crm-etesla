...
Espo.define('google:views/google/fields/labeled-array', 'views/fields/array', function (Dep) {
        ...
        getItemHtml: function (value) {
            ...
            '<div class="list-group-item link-with-role form-inline" data-value="' + value + '">' +
                '<div class="pull-left" style="width: 92%; display: inline-block;">' +
                    '<input data-name="translatedValue" data-value="' + value + '" class="role form-control input-sm pull-right" value="'+identificationLabel+'">' +
                    '<div>' + label + '</div>' +
                '</div>' +
