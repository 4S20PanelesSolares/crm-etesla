...
Espo.define('google:views/google/fields/monitored-contacts-groups', 'views/fields/link-multiple', function (Dep) {
    ...
    return Dep.extend({
        ...
        addLinkHtml: function (id, name) {
            ...
            $el.html(name + '&nbsp');
            $el.append('<a href="javascript:" class="pull-right" data-id="' + id + '" data-action="clearLink"><span class="fas fa-times"></a>');
            conteiner.append($el);
