...
Espo.define('google:views/google/google', ['views/external-account/oauth2', 'model'], function (Dep, Model) {
            ...
            for (key in products) {
                if (products[key]) {
                    ...
                    if (isActive) {
                        ...
                        var viewName = "google:views/google/panels/" + Espo.Utils.camelCaseToHyphen(key.charAt(0).toUpperCase() + key.slice(1));
