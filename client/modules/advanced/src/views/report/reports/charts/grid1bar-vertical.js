...
Espo.define('advanced:views/report/reports/charts/grid1bar-vertical', 'advanced:views/report/reports/charts/grid2bar-vertical', function (Dep) {
            ...
            this.$graph = this.flotr.draw(this.$container.get(0), this.chartData, {
                ...
                yaxis: {
                    ...
                    tickFormatter: function (value) {
                        if (value == 0) return '';
                        if (value > this.max + 0.072 * this.max) return '';
                        if (value % 1 == 0) {
